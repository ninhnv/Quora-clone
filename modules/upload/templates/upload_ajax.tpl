...
<fieldset style="border:1px solid #eee;padding:10px;margin-bottom:10px;margin-left: 20px;" class="upload_ajax">
...
<table class="upload_ajax_table">
	{foreach from=$images item=image}
		{php}
			...
			{
		{/php}
			<tr style="display:none" class="upload_ajax_label">
				<td>{$file}</td>
			</tr>
	...
	<tr class="upload_ajax_remove">
		<td>
			<input type='button' class="btn btn-danger upload_ajax_remove_button" value='Xóa ảnh' onclick='deleteImage({$submit_id},{$number});'>
		</td>
	</tr>
