...
{foreach from=$images item=image}
	...
	{if strpos($image.file_name,'http')===0}
		{if $pagename eq "story"}
			<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;" src='{$image.file_name}' /> </div>
		{else}
			<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;" src='{$image.file_name}' /> </div>
		{/if}
	{elseif $image.file_size=='orig'}
		{if $pagename eq "story"}
				<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;"  src='{$my_pligg_base}{$upload_directory}/{$image.file_name}' /> </div>
			{else}
				<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;"  src='{$my_pligg_base}{$upload_directory}/{$image.file_name}' /> </div>
		{/if}
	{else}
		{if $pagename eq "story"}
			<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;" src='{$my_pligg_base}{$upload_thdirectory}/{$image.file_name}' /></div>
		{else}
			<div class="img-thumb-custom" style="margin-left: 40px;"><img class="img-thumbnail" style="max-width: 100%;margin-top: 5px;margin-bottom: 5px;" src='{$my_pligg_base}{$upload_thdirectory}/{$image.file_name}' /></div>
		{/if}
	{/if}
