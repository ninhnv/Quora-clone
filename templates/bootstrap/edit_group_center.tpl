	...
	<fieldset>
		...
		<form method="POST" class="form-horizontal" enctype="multipart/form-data" name="image_upload_form" action="{$edit_form_action}">
			<div class="control-group">
				...
				<div class="controls">
					...
					<button type="submit" value="{#PLIGG_Visual_Group_Avatar_Upload#}" name="action" class="btn btn-default"><i class="fa fa-white fa-picture-o"></i> {#PLIGG_Visual_Group_Avatar_Upload#}</button>
				</div>
			</div>
		</form> 
		...
		<form method="POST" class="form-horizontal" enctype="multipart/form-data" name="image_upload_form" action="{$edit_form_action}">
			...
			<div class="form-actions">
				<input type="submit" value="{#PLIGG_Visual_Group_Edit#}" class="btn btn-default" name="action" />
