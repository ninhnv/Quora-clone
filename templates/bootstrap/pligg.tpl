...
<head>
	...
	{if $pagename eq "story"}
		{literal}
			<script type="text/javascript">
				$(function () {
					$(".col-md-2").css({"margin-left":"0px","position":"relative","width":"150"});
					$(".col-md-3").css({"margin-left":"0px","position":"relative"});
					$(".col-md-7").css({"margin-left":"0px"});
				});
			</script>
		{/literal}
	{/if}
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=582866691813399&version=v2.0";
...
{/literal}
	...
	<div style="overflow-x: hidden;background-color: #FFFFFF;margin-top: 0px;" class="container">
		<section id="maincontent">
			...
			{*{if $pagename neq "submit" && $pagename neq "user" && $pagename neq "profile" && $pagename neq "user_edit" && $pagename neq "register" && $pagename neq "login"}*}
					...
					<div class="col-md-2" style="width: 200px;">
						<div class="panel panel-default">
							<div style="background-color: #FFFFFF;" id="rightcol" class="panel-body">
									<div class="headline">
										<div class="sectiontitle headline-custom">FEEDS </div>
										<div class="boxcontent">
											<ul style="list-style-type: none;padding: 0 3px;">
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/funny/">Funny</a></li>{else}<li><a class="cate" href="http://wogag.com/funny/">Funny</a>{/if}
												
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/vi-deo/">Video</a></li>{else}<li><a class="cate" href="http://wogag.com/vi-deo/">Video</a>{/if}

												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/news/">News</a></li>{else}<li><a class="cate" href="http://wogag.com/news/">News</a>{/if}
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/question/">Question</a></li>{else}<li><a class="cate" href="http://wogag.com/question/">Question</a>{/if}

												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/girl/">Girl</a></li>{else}<li><a class="cate" href="http://wogag.com/girl/">Girl</a>{/if}

												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/quotes/">Quotes</a></li>{else}<li><a class="cate" href="http://wogag.com/quotes/">Quotes</a>{/if}

												{*<li><a style="color:#C00607" href="#" id="lh-show" class="cate showLink" onclick="showHide('lh');return false;">Xem thêm</a></li>*}
											</ul>
											{* <ul id="lh" class="more" style="list-style-type: none;padding: 0 3px;">	
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/photo/">Girl xinh</a></li>{else}<li><a class="cate" href="http://wogag.com/photo/"> Girl xinh</a>{/if}
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/i-fact/">Có thể bạn chưa biết</a></li>{else}<li><a class="cate" href="http://wogag.com/i-fact/"> Có thể bạn chưa biết</a>{/if}
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/new/giai-tri/">Giải trí</a></li>{else}<li><a class="cate" href="http://wogag.com/giai-tri"> Giải trí</a>{/if}
												{if $pagename eq "new"}<li><a class="cate" href="http://wogag.com/newcong-nghe/">Công nghệ</a></li>{else}<li><a class="cate" href="http://wogag.com/cong-nghe/"> Công nghệ</a>{/if}
												<li><a class="cate" href="">Xem toàn bộ</a></li>
												<li id="lh-hide" class="hideLink" onclick="showHide('lh');return false;"><a style="color:#C00607" class="cate" href="#">Thu gọn</a></li>
											<ul> *}
										</div>
									</div>
							</div>
			...
			{/if}
					<!-- START BREADCRUMB -->
						...
						{*<i class="fa fa-picture-o"><a href=""> Đăng tin   </a></i>
						<i class="fa fa-picture-o"><a href="">  Đăng ảnh </a></i>*}
					<!-- END BREADCRUMB -->
				...
				{if $pagename neq "submit" && $pagename neq "user" && $pagename neq "profile" && $pagename neq "user_edit" && $pagename neq "register" && $pagename neq "login"}
					<!-- START RIGHT COLUMN -->
					<div class="col-md-3">
									<div class="btn-group btn-group-justified" style="display:none ;margin-bottom: 5px;background-color: #f6f6f6;border: 1px solid #ddd;" role="group" aria-label="...">
									  <div class="btn-group" role="group">
									    <button style="background-color: #f6f6f6;" type="button" class="btn"><i class="fa fa-link"></i> URL</button>
									  </div>
									  <div class="btn-group" role="group">
									    <button style="background-color: #f6f6f6;" type="button" class="btn"><i class="fa fa-video-camera"></i> Video</button>
									  </div>
									  <div class="btn-group" role="group">
									    <button style="background-color: #f6f6f6;" type="button" class="btn"><i class="fa fa-picture-o"></i> Ảnh</button>
									  </div>
								</div>
						<div class="panel panel-default">
								<div style="background-color: #f6f6f6;border: 1px solid #ddd;" id="rightcol" class="panel-body">
								<!-- START FIRST SIDEBAR -->
							...
							<span class="subtext" style="font-size: 11px;line-height: 15px;"> 
							<a style="color:#666" href="https://www.facebook.com/pages/Linkhayvncom/1494008070860563" target="_blank">Linkhayvn</a>
							| <a style="color:#666" href="http://linkhayvn.com/regulation.php"> Quy định sử dụng</a>
							| <a style="color:#666" href="#"> Email: linkhayvn.com@gmail.com</a>
						</span>
						</div>
					</div><!--/span-->
					<!-- END RIGHT COLUMN -->
			...
			<footer class="footer" style="margin-top: 10px;text-align: center;">
					{literal}
						...
						<ins class="adsbygoogle"
						     ...
						     data-ad-client="ca-pub-4276172560392969"
						     data-ad-slot="1429131135"></ins>
						<script>
						...
						<div class="control-group">
							<form id="signin" action="{$URL_login}" method="post">
								...
								<div class="login_modal_login">
									...
									<input class="btn btn-default col-md-12" id="signin_submit" value="{#PLIGG_Visual_Login_LoginButton#}" tabindex="4" type="submit">
								</div>
