	...
	<div style="float:left;margin:0 0 10px 10px;" class="col-md-7">
						...
						<form method="POST" enctype="multipart/form-data" name="image_upload_form" action="{$form_action}">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="submit" name="action" class="btn btn-default"><span class="fa fa-white fa fa-picture"></span> {#PLIGG_Visual_Group_Avatar_Upload#}</button>
		...
		{elseif $group_status eq 'disable'}
			<div class='group_approve'>
				<button onclick='document.location="?approve={$group_id}"'class='btn btn-default group_approve_button'>Approve</button>
			</div>
		{/if}
	</div>
