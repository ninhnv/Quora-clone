...
<!-- story_center.tpl -->
{$the_story}
<div style="margin-left: 40px;padding-bottom: 10px;" class="fb-like" data-href="{$story_url}" data-layout="standard" data-action="like" data-show-faces="false" data-share="true"></div>
{*{checkActionsTpl location="upload_story_list_custom"}*}
<ul style="background-color: white;margin-left: 40px;" class="nav nav-tabs" id="storytabs">
	<li  class="active"><a data-toggle="tab" href="#facebook_cm"><i class="fa fa-comments"></i> Bình luận </a></li>
	<li style="display:none"><a data-toggle="tab" href="#comments"><i class="fa fa-comments"></i> Linkhayvn</a></li>
	...
	{if count($related_story) neq 0}<li><a data-toggle="tab" href="#related"><i class="fa fa-tag"></i>Xem nhiều </a></li>{/if}
...
{literal}
	...
	$(function () {
		...
		$('#storytabs a[href="#facebook_cm"]').tab('show');
	});
...
<div style="background-color: white;" id="tabbed" class="tab-content">

	<div style="margin-left: 40px;" class="tab-pane fade active in" id="comments" >
	...
	<div  style="margin-left: 40px;" class="tab-pane fade active in" id="facebook_cm" >
			<div class="fb-comments" data-href="{$my_base_url}{$story_url}" data-width="100%" data-numposts="10" data-colorscheme="light"></div>
	</div>
	
	{if count($voter) neq 0}
		<div  style="margin-left: 40px;" class="tab-pane fade" id="who_voted">
